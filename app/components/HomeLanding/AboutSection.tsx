...
export default function AboutSection() {
  return (
    <div className="bg-light-pink max-w-[90%] 2xl:max-w-[80%] mt-12 rounded-md flex flex-col md:flex-row justify-center sm:px-24 md:px-4 lg:px-24 gap-10 xl:gap-32 2xl:gap-48 mb-24  pb-24 lg:pb-32 pt-12 lg:pr-12">
      <div>
        <Image
      ...
      <div>
        <h1 className="font-outfit   sm:text-4xl lg:text-5xl  max-w-xl">
