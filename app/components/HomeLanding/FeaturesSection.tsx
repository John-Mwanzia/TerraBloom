...
export default function FeaturesSection() {
  return (
    <div className=" max-w-[95%] xl:max-w-[90%] 2xl:max-w-[80%] mb-24 px-32">
      ...
      <div className="mt-28">
        <div className="flex justify-center flex-col lg:flex-row gap-32 xl:gap-40 2xl:gap-72 mb-20">
          <div className="bg-[#89898a42] relative transform -skew-x-12 scale-y-100 text-center px-12 py-20 rounded-3xl shadow-xl">
            ...
            />
            <h3 className="mb-12 ml-12 md:ml-32 lg:ml-12 text-2xl text-start font-outfit text- skew-x-12  max-w-[15rem]">
              Real-Time Weather Updates
            </h3>
            <p className="max-w-xs skew-x-12 md:ml-16 lg:ml-0">
          ...
          <div className="bg-white/70  relative transform -skew-x-12 scale-y-100 text-center px-12 py-20 rounded-3xl shadow-xl">
            <Image
              ...
              className="absolute -left-16 skew-x-12"
            />
            <h3 className="mb-12 ml-12 md:ml-32 lg:ml-12 text-2xl skew-x-12 font-outfit text-start  max-w-[15rem]">
        ...
        <div className="flex justify-center flex-col lg:flex-row gap-32 xl:gap-40 2xl:gap-72">
          <div className="bg-white/70  relative transform -skew-x-12 scale-y-100 text-center px-12 py-20 rounded-3xl shadow-xl">
            <Image
              ...
              className="absolute -left-16 skew-x-12"
            />
            <h3 className="mb-12 ml-12 md:ml-32 lg:ml-12 text-2xl font-outfit text-start  max-w-[15rem] skew-x-12">
