...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className=" pl-4 mt-12 max-w-[11.5rem] sm:max-w-sm sm:mt-32 xl:mt-42 2xl:mt-48 md:pl-6 xl:pl-8 2xl:pl-12 xl:max-w-xl md:max-w-sm mb-6 sm:mb-10 xl:mb-16">
